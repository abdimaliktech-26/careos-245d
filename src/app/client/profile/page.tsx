  ...
  return (
    <div className="max-w-lg space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-[13px] text-muted-foreground">Your account details and preferences.</p>
      </div>
      ...
      <div className="care-panel rounded-2xl p-6 flex items-center gap-5">
        ...
        <div>
          ...
          <p className="text-[13px] text-muted-foreground capitalize mt-0.5">{roleLabel}</p>
        </div>
      </div>
      ...
      <div className="care-panel rounded-2xl p-6">
        <h2 className="text-sm font-bold text-foreground mb-2">Need Help?</h2>
