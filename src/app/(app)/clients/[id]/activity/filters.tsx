...
const TYPE_OPTIONS = [
  ...
  { value: 'evv',       label: 'EVV',        color: 'bg-purple-50 text-purple-700 border-purple-200' },
  ...
  { value: 'message',   label: 'Messages',   color: 'bg-indigo-50 text-indigo-700 border-indigo-200' },
