...
function BadgeNew() {
  return (
    <span className="inline-flex items-center rounded-full bg-[#E8799E]/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-[#E8799E]">
      New
    </span>
  )
}
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {['Analyses', 'Fatal Five Detection', 'QA Assistant', 'AI Translation'].map((title) => (
            <a
              ...
              className="group rounded-2xl border border-[#E5E7EB] bg-white p-5 text-center shadow-sm transition hover:shadow-md hover:border-[#C7D2FE]"
            >
              <h3 className="text-sm font-bold text-[#111827] group-hover:text-[#E8799E] transition-colors">{title}</h3>
            </a>
          ))}
        </div>
      </section>
      ...
      <section id="analyses" className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
        ...
        <h2 className="text-2xl font-black text-[#111827]">Analyses</h2>
        ...
        <p className="mt-6 text-sm font-bold text-[#111827]">AI Analyses helps your team:</p>
        <ul className="mt-3 space-y-2">
          {[
            ...
            <li key={item} className="flex items-start gap-2.5 text-sm leading-6 text-[#6B7280]">
              <span className="mt-0.5 shrink-0 text-[#E8799E]"><CheckIcon /></span>
              {item}
            </li>
          ))}
        </ul>
      ...
      <section id="fatal-five-detection" className="border-y border-[#E5E7EB] bg-white">
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
          <div className="mb-3">
            <BadgeNew />
          </div>
          <h2 className="text-2xl font-black text-[#111827]">Fatal Five Detection</h2>
          <p className="mt-4 text-[15px] leading-7 text-[#6B7280]">
          ...
          <p className="mt-6 text-sm font-bold text-[#111827]">Fatal Five Dashboard provides:</p>
          <ul className="mt-3 space-y-2">
            {[
      ...
      <section id="qa-assistant" className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
        ...
        <h2 className="text-2xl font-black text-[#111827]">QA Assistant</h2>
        <p className="mt-4 text-[15px] leading-7 text-[#6B7280]">
        ...
        <p className="mt-6 text-sm font-bold text-[#111827]">QA Assistant helps your team:</p>
        <ul className="mt-3 space-y-2">
          {[
      ...
      {/* AI Translation */}
      <section id="ai-translation" className="border-y border-[#E5E7EB] bg-white">
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
          <div className="mb-3">
            <BadgeNew />
          </div>
          <h2 className="text-2xl font-black text-[#111827]">AI Translation</h2>
          <p className="mt-4 text-[15px] leading-7 text-[#6B7280]">
          ...
          <p className="mt-6 text-sm font-bold text-[#111827]">AI Translation tool provides:</p>
          <ul className="mt-3 space-y-2">
            {[
