  ...
  return (
    <form onSubmit={handleSubmit} className="bg-background border border-border rounded-xl p-4 space-y-3 mt-3">
      <div className="flex items-center justify-between">
        <p className="text-sm font-semibold text-foreground">New Medication</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="col-span-2">
          <label className="text-xs font-medium text-muted-foreground block mb-1">Medication Name</label>
        ...
        <div>
          <label className="text-xs font-medium text-muted-foreground block mb-1">Prescribed By</label>
          <input name="prescribed_by" className="care-input w-full rounded-lg border px-3 py-2 text-sm" />
        </div>
        <div>
          <label className="text-xs font-medium text-muted-foreground block mb-1">Prescribing Physician</label>
          <input name="prescribing_physician" className="care-input w-full rounded-lg border px-3 py-2 text-sm" />
        </div>
        <div>
          <label className="text-xs font-medium text-muted-foreground block mb-1">Pharmacy Name</label>
          <input name="pharmacy_name" className="care-input w-full rounded-lg border px-3 py-2 text-sm" />
        </div>
        <div>
          <label className="text-xs font-medium text-muted-foreground block mb-1">Pharmacy Phone</label>
