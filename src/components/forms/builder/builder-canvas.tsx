  ...
  return (
    <div
      ...
      className={`group relative rounded-lg border px-4 py-3 cursor-pointer transition-all ${
        isSelected
          ? 'border-primary bg-primary/5 ring-1 ring-ring/20'
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-foreground truncate">{field.label || <span className="text-muted-foreground italic">Untitled field</span>}</p>
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
          <button
            ...
            disabled={index === 0}
            className="p-1 rounded hover:bg-muted/40 text-muted-foreground disabled:opacity-20"
            title="Move up"
          >
