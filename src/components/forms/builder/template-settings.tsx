...
export function TemplateSettingsForm({
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-xs font-semibold tracking-[0.08em] text-gray-400 uppercase">Template Settings</h3>
      ...
      <div>
        <label className="block text-xs font-medium text-gray-700 mb-1">Packet Types</label>
